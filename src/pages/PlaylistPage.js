...
import { setCurrentPlaylistName, setCurrentSongId, setPlay, setPlaylistSongs } from "../store/actions/get_music"
...
const PlaylistPage = () => {
    ...
    return (
        <div className="flex relative justify-between px-10 gap-6 w-full h-full overflow-hidden">
            {
